...
import { Flex, Box, Text, Button, Container, Heading, useColorModeValue, Grid, GridItem, Icon } from '@chakra-ui/react';
...
export default function NexusWallet() {
  ...
  useEffect(() => {
    const fetchCredential = async () => {
      ...
      setRegCredential(storedCredential || null);
      setMember(storedMemberInfo || null);
    };
      ...
      <Container maxW="container.xl">
        ...
        <Flex justifyContent="center" alignItems="center" gap={6}>
          <Button
            ...
            py={6}
            px={8}
            isDisabled={!shouldShowSignUpButton}
          >
            secp256r1 키 생성
          </Button>
          <Button
            ...
            py={6}
            px={8}
            isDisabled={!shouldShowSignInButton}
          >
